...
HRESULT progressBar::init(float x, float y, int width, int height)
{
	...
	_progressBarTop = IMAGEMANAGER->addImage("frontBar", "image/hpBarTop.bmp", width, height, true, RGB(255, 0, 255));
	_progressBarBottom = IMAGEMANAGER->addImage("backBar", "image/hpBarBottom.bmp", width, height, true, RGB(255, 0, 255));
